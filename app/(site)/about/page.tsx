  ...
  return (
    <section className="max-w-2xl mx-auto px-4 py-16 space-y-12">
      ...
      <div className="space-y-4">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
          배운 것을 기록하고, 직접 만들어보며 이해를 쌓아가는 방식으로 성장하고
          있습니다.
          <br></br>이 블로그는 그 과정을 남기는 공간입니다.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3 text-neutral-700 dark:text-neutral-300">
          <li className="flex gap-3">
            <span className="font-medium text-neutral-900 dark:text-neutral-100 w-12 shrink-0">
              Blog
            </span>
            <span>
              학습하고 구현하며 정리한 기술 글. 주로 React, Next.js,
              TypeScript를 다룹니다.
            </span>
          </li>
          <li className="flex gap-3">
            ...
            <span>
              짧은 메모, CS 정리, 개념 스케치처럼 가볍게 기록하는 공간입니다.
            </span>
          </li>
        </ul>
      </div>
