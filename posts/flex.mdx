...
다크 배경에 상단 accent 바, 제목과 작성자/날짜를 flex로 배치한 형태다.

<OgOgCardNew />

`flexDirection: "column"`과 `justifyContent: "space-between"`으로 상단 사이트명, 중앙 제목, 하단 메타 정보를 깔끔하게 분리했다.

---

<i>모든 내용은 [1분코딩](https://studiomeal.com/archives/197) 을 참고했다.</i>
