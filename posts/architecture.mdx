---
title: "Server Action vs API Route — 언제 무엇을 써야 할까"
publishedAt: "2026-01-04"
summary: "모든 API를 Server Action으로 대체할 수 있을까? 직접 구현하며 느낀점"
tags: ["Next.js", "Frontend", "Architecture"]
---

## 리팩토링을 하다 보니, 어떤 로직은 route.ts에 있고, 어떤 로직은 Server Action으로 되어 있었다. 그때 문득 “기준이 뭐지?”라는 생각이 들었다.
