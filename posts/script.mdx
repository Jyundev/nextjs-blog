...
mdxComponents는 자동화 스크립트를 통해 채워진다.
해당 스크립트는 모든 컴포넌트를 탐색해 index.ts 파일을 생성한다.
...
정리하자면, mdx.tsx에서 컴포넌트를 직접 관리하는 수고를 줄일 수 있고, 스크립트를 통해 자동화하여 유지보수성을 크게 높일 수 있다.
